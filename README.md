...
### segment data
The segment data can be generated by segAnglePo function in the package. There is no need for the user to build the segment data if plotting human or mouse genome. The segment data sets for human and mouse were built in the package. For example:
```r
library(OmicCircos)
data(UCSC.hg19)
head(UCSC.hg19)
```
<img src="out/segment_data.png" width="300" height="600"> 
